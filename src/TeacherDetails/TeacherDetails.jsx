...
export default function TeacherDetails({setShowTeacherDetails}) {
  return (
    <div style={{padding: '20px 400px 20px 150px', width:'100vw', display:'flex', flexDirection:'column'}}>
      {/* teacher */}
      <div style={{display:'flex'}}>
        {/* info */}
        <div style={{flexGrow:8, paddingRight:20, textAlign:'left'}}>
          <Typography variant="h6" style={{textTransform:'uppercase'}}>Instructor</Typography>
          <Typography variant="h4" style={{fontWeight:'bold'}}>{teacher.name}</Typography>
          <Typography variant="subtitle1" style={{fontWeight:'bold', margin:'10px 0'}}>{teacher.role}</Typography>
          <div style={{display:'flex', margin:'30px 0px'}}>
            <div style={{display:'flex', flexDirection:'column', marginRight:30}}>
              <Typography variant="subtitle1" >Total students</Typography>      
              <Typography variant="subtitle1" style={{fontWeight:'bold'}}>{teacher.totalStudents}</Typography>      
            </div>
            <div>
              <Typography variant="subtitle1" >Reviews</Typography>      
              <Typography variant="subtitle1" style={{fontWeight:'bold'}}>{teacher.totalRate}</Typography>
            </div>
          </div>
          <div className='about-teachers'>
            <Typography variant="h6" style={{fontWeight:'bold'}}>About me</Typography>
            <Typography variant="subtitle1" >{teacher.exp}</Typography>      
            <Typography variant="subtitle1" >Language: {teacher.language.join(', ')}</Typography>      
        ...
        <div style={{flexGrow:2, paddingLeft:20}}>
          ...
          <Button variant="outlined" style={{width:160, marginTop:20, justifyContent:"space-evenly"}}><FaFacebook/>FaceBook</Button>
          <Button variant="outlined" style={{width:160, margin:'10px 0',  justifyContent:"space-evenly"}}><FaLinkedin />Linkedin</Button>
          <Button variant="outlined" style={{width:160,  justifyContent:"space-evenly"}}><FaYoutube/>Youtube</Button>
        </div>
      </div>
      {/* courses */}
      <Box sx={{ flexGrow: 1 }}>
          ...
          courses.map((course)=>{
            return ( 
              ...
              <Card sx={{ maxWidth: 354 }}>
                ...
                <CardActions>
                  <Button size="small" style={{cursor:'poiter'}} onClick={()=>setShowTeacherDetails(false)}>Share</Button>
                  <Button size="small" style={{cursor:'poiter'}} onClick={()=>setShowTeacherDetails(false)}>Learn More</Button>
                </CardActions>
              </Card>
              </Grid>
